...
_INITIALIZER_FACTORY = determinism.DeterministicInitializerFactory(123456)

class TokenEmbedding(layers.Layer):
    def __init__(self, num_vocab=1000, maxlen=100, num_hid=64):
        super().__init__()
        self.emb = tf.keras.layers.Embedding(num_vocab, num_hid,
            embeddings_initializer=_INITIALIZER_FACTORY.make_initializer_v2("uniform")
        )
...
class SpeechFeatureEmbedding(layers.Layer):
    def __init__(self, num_hid=64, maxlen=100):
        ...
        self.conv1 = tf.keras.layers.Conv1D(
            ...
            kernel_initializer=_INITIALIZER_FACTORY.make_initializer_v2("glorot_uniform")
        )
